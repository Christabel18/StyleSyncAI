  ...
  return (
    <div className="flex flex-col">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-12 px-5 py-16 sm:px-8 sm:py-24 lg:grid-cols-2">
          <div className="animate-float-up">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                href="/onboarding"
                className="btn-shimmer inline-flex h-11 items-center gap-2 rounded-full px-7 text-sm font-semibold shadow-md transition-transform hover:scale-105 active:scale-95"
              >
                Get started
              ...
              <Link
                href="/upload"
                className="inline-flex h-11 items-center gap-2 rounded-full border border-line bg-white px-7 text-sm font-semibold text-ink transition-colors hover:border-ink"
              >
            ...
            <div className="mt-8 flex items-center gap-3">
              <div className="flex -space-x-2">
                {["#9b5de5","#f15bb5","#fee440","#00bbf9"].map(c => (
                  <div key={c} className="h-7 w-7 rounded-full border-2 border-cream" style={{ background: c }} />
                ))}
              </div>
      ...
      <section className="border-y border-line bg-sand/40 py-16 sm:py-20">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="text-center">
            <span className="rounded-full bg-pop-purple/10 px-4 py-1.5 text-sm font-medium text-pop-purple">How it works</span>
            ...
            {STEPS.map((s) => (
              <div key={s.title} className="group relative overflow-hidden rounded-3xl border border-line bg-white p-6 transition-all hover:-translate-y-1 hover:shadow-md">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-2xl font-semibold text-line">{s.n}</span>
                </div>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
            <div>
              <span className="rounded-full bg-pop-pink/10 px-4 py-1.5 text-sm font-medium text-pop-purple">Features</span>
              <h2 className="mt-4 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
              ...
              <Link href="/onboarding" className="mt-6 inline-flex h-11 items-center gap-2 rounded-full bg-ink px-7 text-sm font-semibold text-cream transition-colors hover:bg-clay">
      ...
      <section className="border-t border-line bg-sand/40 py-16 sm:py-24">
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <div className="text-center">
            <span className="rounded-full bg-clay-soft px-4 py-1.5 text-sm font-medium text-clay">Your stylists</span>
            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-3">
            {[
              ...
              <div key={name} className="rounded-3xl border p-7 text-center transition-all hover:-translate-y-1 hover:shadow-md" style={{ borderColor: color + "40", background: bg }}>
                ...
                <p className="text-xs font-semibold uppercase tracking-wider" style={{ color }}>{styles}</p>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] border border-line bg-white px-8 py-14 text-center">
            ...
            <div className="relative">
              ...
              <div className="mt-7 flex flex-wrap justify-center gap-2">
                {STYLES.map((s) => (
                  <Link key={s.id} href="/onboarding"
                    className="rounded-full border border-line bg-cream px-4 py-1.5 text-sm text-ink-soft transition-all hover:border-clay hover:text-clay"
                  >
              ...
              <Link href="/onboarding"
                className="btn-shimmer mt-8 inline-flex h-11 items-center gap-2 rounded-full px-9 text-sm font-semibold shadow-lg transition-transform hover:scale-105 active:scale-95"
              >
